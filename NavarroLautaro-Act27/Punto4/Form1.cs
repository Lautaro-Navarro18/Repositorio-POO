...
namespace Punto4
{
    ...
    Requisitos:
     ...
     ● Dos RadioButton deben permitir seleccionar sí recomiendan el producto: "Si" o "No".
     ● Al hacer clic en el botón "Enviar", se debe mostrar un Label con el mensaje: "Opinión recibida: [texto] – Recomendación: [Sí/No]. 
    */
